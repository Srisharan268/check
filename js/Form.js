class Form{
    ...
    hostPressed(){
        ...
        this.button2.position(805,500);
        this.codeI.position(605,450);
        this.nameI.position(605,400);
        this.nameI.show();
        this.codeI.show();
        this.button2.show();
        this.hostb.hide();
    ...
    joinPressed(){
        this.button2.position(805,450);
        this.codeI.position(605,400);
        this.nameI.position(605,350);
        this.nameI.show();
        this.button2.show();
        this.codeI.show();
        this.hostb.hide();
    ...
    choose(){
        var pos = displayWidth/2-104
        this.host.position(pos,290);
        this.hostb.position(pos,290);
        this.join.position(pos,420);
        this.joinb.position(pos,420);
        this.host.show();
        this.hostb.show();
        this.join.show();
        this.joinb.show();
